...
public class JdbcHelper {
    ...
    public static List query(String sql, Map<Integer,Object> paramMap)
            throws SQLException {
        ...
        try {
            ...
            if (paramMap != null && paramMap.size() > 0) {
                ...
                for (Integer i:keySet){
                    preparedStatement.setObject(i , paramMap.get( i ).toString());
                }
            }

//            for (int i = 0; i < paramMap.size(); i++) {
//                preparedStatement.setObject(i + 1, paramMap.entrySet(). ));
//            }
            rs = preparedStatement.executeQuery();
            return ResultToListMap(rs);
        } catch (SQLException e) {
